...
import type { TranscriptEvent } from './useAcpAgent'
 ...
 * component tree under `components/chat/messages/`.
 */
 ...
 */
export function useAcpTranscript(transcript: Ref<TranscriptEvent[]> | TranscriptEvent[], sessionId?: Ref<string>) {
