...
import { SessionState, type SessionStateEvent } from './useAcpAgent'
 ...
 */
export function useAcpSessionHistory(agentId: Ref<string | undefined>, profileId: Ref<string | undefined>) {
