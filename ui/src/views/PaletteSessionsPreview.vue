...
import { type PaletteEntry } from '@composables/palette'
import { useHomeDir } from '@composables/use-home-dir'
import { truncateCwd } from '@composables/use-session-info'
import { getSessionInfo, type SessionInfoResult } from '@ipc'
...
<template>
  <div class="palette-sessions-preview" data-testid="palette-sessions-preview">
    ...
    <div v-else-if="loading" class="palette-sessions-preview-state-msg" data-testid="palette-sessions-preview-loading">loading…</div>
    ...
    <template v-else-if="info">
      ...
      <dl class="palette-sessions-preview-meta">
        <div>
          <dt>id</dt>
          <dd class="palette-sessions-preview-id">{{ info.id }}</dd>
        </div>
        <div>
          <dt>cwd</dt>
