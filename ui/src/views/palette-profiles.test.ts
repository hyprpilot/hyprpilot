...
import { buildProfilesLeafEntries, buildProfilesPaletteSpec, openProfilesLeaf } from './palette-profiles'
...
describe('openProfilesLeaf', () => {
  ...
  it('toasts and bails when the profiles registry has not loaded yet', () => {
    profilesRef.value = []
