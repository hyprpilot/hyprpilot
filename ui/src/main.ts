...
import { applyGtkFont, applyTheme, applyWindowState, loadHomeDir, loadKeymaps } from '@composables'
...
async function boot(): Promise<void> {
  await Promise.all([applyTheme(), applyWindowState(), applyGtkFont(), loadHomeDir(), loadKeymaps()])
